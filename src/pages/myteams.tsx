  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center h-[90%] text-neutral-500">
        <div id="myteams">{username}'s teams</div>
        <div className="flex items-center justify-center w-[100%] h-[100%]">
          {privateTeams.length > 0 ?
            privateTeams.map((team, index) => (
              <div key={index} id="miniteam" className="flex flex-col items-center justify-center w-[25%] h-[50%] border-neutral-500 border-solid border-[2px] rounded m-[1%]">
                <div className="flex items-center justify-center w-[100%] h-[20%]">
                  <div id="teaminfoz" className="w-1/2 h-full flex items-center justify-center border-neutral-500 border-solid border-[2px]">{privateTitles[index]}</div>
                  <div id="teaminfoz" className="w-1/4 h-full flex items-center justify-center border-neutral-500 border-solid border-[2px]">{privateTiers[index]}</div>
                  <div id="teaminfoz" className="w-1/4 h-full flex items-center justify-center border-neutral-500 border-solid border-[2px]">{privateisPublics[index] ? 'Public' : 'Private'}</div>
                </div>
